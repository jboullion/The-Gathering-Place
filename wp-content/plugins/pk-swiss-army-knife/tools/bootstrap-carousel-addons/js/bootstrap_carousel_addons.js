if(!jQuery.mobile){
	addJqueryMobile();
	addJquerySwipeUpDown();
}

//Enables Swiping to advance the carousel
jQuery(function($){
	$(".carousel.slide.swipe").swiperight(function() {  
    	$(this).carousel('prev');  
	});  
	$(".carousel.slide.swipe").swipeleft(function() {  
		$(this).carousel('next');  
	}); 
	$(".carousel.slide.vert-swipe").on('swipeup',function() {  
		$(this).carousel('next');  
	}); 
	$(".carousel.slide.vert-swipe").on('swipedown',function() {  
		$(this).carousel('prev');  
	}); 
});
